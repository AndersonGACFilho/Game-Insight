...
public class IgdbService {
     ...
     *
     * @return HttpHeaders containing authorization and content type.
     */
    ...
    @Transactional
    protected void ProcessGame(IgdbGameDto game) {
        // Process the game
        try {
            ...
            if (game.getAgeRatings() != null) {
                ...
                for (Integer ageRatingId : game.getAgeRatings()) {
                    AgeRating ageRatingEntity = SearchForAgeRatings(Math.toIntExact(ageRatingId));
            ...
            if (game.getFranchises() != null) {
                ...
                for (Integer franchiseId : game.getFranchises()) {
                    Franchise franchiseEntity = SearchForFranchises(Math.toIntExact(franchiseId), gameEntity);
            ...
            if (game.getGameLocalizations() != null) {
                ...
                for (Integer localizationId : game.getGameLocalizations()) {
                    Localization localizationEntity = SearchForLocalizations(Math.toIntExact(localizationId), gameEntity);
            ...
            if (game.getInvolvedCompanies() != null) {
                ...
                for (Integer companyId : game.getInvolvedCompanies()) {
                    CompanyGame companyGame = SearchForInvolvedCompanies(Math.toIntExact(companyId), gameEntity);
                    if (companyGame != null) {
    ...
    /**
     * Retrieves the cover URL for a game.
     *
     * @param coverId The IGDB ID of the cover image.
    ...
    /**
     * Searches for a release date by its IGDB ID.
     *
     * @param releaseDateId The IGDB ID of the release date.
     * @param game          The Game entity.
     * @return The ReleaseDate entity.
     */
    private ReleaseDate SearchForReleaseDates(Integer releaseDateId, Game game) {
        ...
        ResponseEntity<String> response = SendRequest(Math.toIntExact(releaseDateId), releaseDatesEndpoint, "date", "platform", "region");
    ...
    /**
     * Searches for a region by its IGDB ID.
     *
     * @param regionIgdbId The IGDB ID of the region.
    ...
    /**
     * Searches for a genre by its IGDB ID.
     *
     * @param genreId The IGDB ID of the genre.
    ...
    /**
     * Searches for an age rating by its IGDB ID.
     *
     * @param ageRatingId The IGDB ID of the age rating.
     * @return The AgeRating entity.
     */
    ...
    /**
     * Searches for a player perspective by its IGDB ID.
     *
     * @param playerPerspectiveId The IGDB ID of the player perspective.
     * @return The PlayerPerspective entity.
     */
    ...
    /**
     * Searches for a game theme by its IGDB ID.
     *
     * @param themeId The IGDB ID of the theme.
     * @return The GameTheme entity.
     */
    ...
    /**
     * Searches for a game mode by its IGDB ID.
     *
     * @param gameModeId The IGDB ID of the game mode.
     * @return The GameMode entity.
     */
    ...
    /**
     * Searches for a franchise by its IGDB ID and associates it with a game.
     *
     * @param franchiseId The IGDB ID of the franchise.
    ...
    /**
     * Searches for a localization by its IGDB ID.
     *
     * @param localizationId The IGDB ID of the localization.
     * @param game           The Game entity.
     * @return The Localization entity.
     */
    ...
    /**
     * Searches for an involved company by its IGDB ID and associates it with a game.
     *
     * @param companyId The IGDB ID of the involved company.
     * @param game      The Game entity.
     * @return The CompanyGame entity.
     */
    private CompanyGame SearchForInvolvedCompanies(Integer companyId, Game game) {
        ...
        try {
            ...
            Company company = SearchForCompanies(Math.toIntExact(companyFound.getCompany()), newCompanyGame);
            newCompanyGame.setCompany(company);

            // Save and return the company game
            companyGameRepository.save(newCompanyGame);
    ...
    /**
     * Searches for a company by its IGDB ID.
     *
     * @param companyId   The IGDB ID of the company.
     * @param companyGame The CompanyGame entity.
    ...
    /**
     * Searches for a company's logo by its IGDB ID.
     *
     * @param logoId The IGDB ID of the logo.
     * @return The logo URL.
     */
    private String SearchForCompanyLogo(Integer logoId) {
        logger.info("Searching for company logo with ID: {}", logoId);

        ResponseEntity<String> response = SendRequest(Math.toIntExact(logoId), companyLogosEndpoint);
